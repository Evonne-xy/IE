...
class VW_Parallax_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'vw-parallax' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $vw_parallax_font_awesome_icon_array = vw_parallax_font_awesome_icon_array();
                    foreach ($vw_parallax_font_awesome_icon_array as $vw_parallax_font_awesome_icon) {
                            $icon_class = $this->value() == $vw_parallax_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($vw_parallax_font_awesome_icon).'"></i>
                            <span class="vw-parallax-social-class">'.esc_attr($vw_parallax_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function vw_parallax_customizer_script() {
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'vw-parallax-customizer-script', esc_url(get_template_directory_uri()).'/assets/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'vw_parallax_customizer_script' );

if(!function_exists('vw_parallax_font_awesome_icon_array')){
    function vw_parallax_font_awesome_icon_array(){
