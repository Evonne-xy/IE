...
The Mesmerize Companion plugin features include:
...
Mesmerize Companion WordPress plugin, Copyright (C) 2017 Horea Radu
Mesmerize Companion WordPress plugin is licensed under the GPL3 (https://www.gnu.org/licenses/gpl-3.0.en.html).
...
* countUp.js @inorganik - https://github.com/inorganik/countUp.js
  Licensed under the MIT license (https://opensource.org/licenses/MIT)
